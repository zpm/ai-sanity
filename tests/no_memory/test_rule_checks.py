...
from no_memory.pretooluse_bash import PreToolUseBashMemoryRuleChecks
from no_memory.pretooluse_read import PreToolUseReadRuleChecks
...
class TestCheckNoMemoryAccess(unittest.TestCase):
    ...
    def test_blocks_read_under_auto_memory_directory(self):
        ...
        deny_reason = PreToolUseReadRuleChecks.check_no_memory_access_for_read_or_glob_or_grep(payload)
    ...
    def test_blocks_bash_cd_into_memory_directory(self):
        ...
        deny_reason = PreToolUseBashMemoryRuleChecks.check_no_memory_access_for_bash(payload)
        self.assertIsNotNone(deny_reason)
