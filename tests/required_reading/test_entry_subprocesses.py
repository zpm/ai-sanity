########################################################################################################################
# tests/required_reading/test_entry_subprocesses.py
#
# required-reading entry-script subprocess tests
########################################################################################################################
...
PRE_TOOL_USE_PAYLOAD_FIXTURE_BUILDER = tests._common.fixtures.PreToolUsePayloadFixtureBuilder
...
class PreToolUseRequiredReadsSubprocessTestCase(
    ...
    def test_malformed_project_manifest_does_not_prevent_global_rule_from_firing(self):
        ...
        REQUIRED_READS_MANIFEST_FIXTURE_BUILDER.write_raw_manifest_body(
    ...
    def test_notebook_edit_with_matching_rule_emits_deny(self):
        ...
        notebook_edit_payload = PRE_TOOL_USE_PAYLOAD_FIXTURE_BUILDER.build_base_payload(
    ...
    def test_payload_missing_file_path_field_passes_through(self):
        ...
        malformed_edit_payload = PRE_TOOL_USE_PAYLOAD_FIXTURE_BUILDER.build_base_payload(
            tool_name = "Edit",
            tool_input = {}
        )
        exit_code, parsed_stdout = HOOK_ENTRY_SCRIPT_INVOCATION_HELPER.invoke_entry_script(
    ...
    def test_read_of_python_file_with_matching_rule_emits_deny_envelope(self):
        ...
        exit_code, parsed_stdout = HOOK_ENTRY_SCRIPT_INVOCATION_HELPER.invoke_entry_script(
            entry_script_relative_path = "required_reading/pretooluse.py",
            pretooluse_payload = PRE_TOOL_USE_PAYLOAD_FIXTURE_BUILDER.build_read_payload(
...
class PostToolUseReadObserverSubprocessTestCase(
    ...
    def test_read_of_required_doc_causes_next_pretooluse_edit_to_pass_through(self):
        ...
        read_payload = PRE_TOOL_USE_PAYLOAD_FIXTURE_BUILDER.build_posttooluse_read_payload(
            file_path = python_style_doc_abs_path,
        ...
        edit_payload = PRE_TOOL_USE_PAYLOAD_FIXTURE_BUILDER.build_edit_payload(
            new_string_content = "x",
    ...
    def test_read_of_unrelated_doc_does_not_satisfy_any_rule(self):
        ...
        read_of_unrelated_payload = PRE_TOOL_USE_PAYLOAD_FIXTURE_BUILDER.build_posttooluse_read_payload(
    ...
    def test_non_read_tool_posttooluse_payload_passes_through(self):
        ...
        not_read_payload = PRE_TOOL_USE_PAYLOAD_FIXTURE_BUILDER.build_posttooluse_read_payload(
...
class PreCompactRequiredReadsSubprocessTestCase(
    ...
    def test_precompact_clears_existing_satisfaction_flags_for_the_session(self):
        ...
        precompact_payload = PRE_TOOL_USE_PAYLOAD_FIXTURE_BUILDER.build_precompact_payload()
        HOOK_ENTRY_SCRIPT_INVOCATION_HELPER.invoke_entry_script(
            entry_script_relative_path = "required_reading/precompact.py",
            pretooluse_payload = precompact_payload
        )
        post_compact_edit_payload = PRE_TOOL_USE_PAYLOAD_FIXTURE_BUILDER.build_edit_payload(
            new_string_content = "x",
            file_path = os.path.join(self.sandboxed_home_abs_path, "main.py")
        )
        exit_code, parsed_stdout = HOOK_ENTRY_SCRIPT_INVOCATION_HELPER.invoke_entry_script(
