...
class TestCheckNoBuiltinToolBypass(unittest.TestCase):
    ...
    def test_blocks_cat(self):
        ...
        result = PreToolUseBashCommandRuleChecks.check_no_builtin_tool_bypass(self._build("cat file.txt"))
        self.assertIsNotNone(result)
        self.assertIn("Read, Grep, and Glob", result)

    def test_blocks_cat_no_args(self):

        result = PreToolUseBashCommandRuleChecks.check_no_builtin_tool_bypass(self._build("cat"))
        self.assertIsNotNone(result)

    def test_blocks_head(self):

        result = PreToolUseBashCommandRuleChecks.check_no_builtin_tool_bypass(self._build("head -n 10 file.txt"))
        self.assertIsNotNone(result)

    def test_blocks_tail(self):

        result = PreToolUseBashCommandRuleChecks.check_no_builtin_tool_bypass(self._build("tail -f log.txt"))
        self.assertIsNotNone(result)

    def test_blocks_less(self):

        result = PreToolUseBashCommandRuleChecks.check_no_builtin_tool_bypass(self._build("less file.txt"))
        self.assertIsNotNone(result)

    def test_blocks_more(self):

        result = PreToolUseBashCommandRuleChecks.check_no_builtin_tool_bypass(self._build("more file.txt"))
        self.assertIsNotNone(result)

    def test_blocks_bat(self):

        result = PreToolUseBashCommandRuleChecks.check_no_builtin_tool_bypass(self._build("bat file.txt"))
        self.assertIsNotNone(result)

    def test_blocks_grep(self):

        result = PreToolUseBashCommandRuleChecks.check_no_builtin_tool_bypass(self._build("grep pattern file.txt"))
        self.assertIsNotNone(result)

    def test_blocks_rg(self):

        result = PreToolUseBashCommandRuleChecks.check_no_builtin_tool_bypass(self._build("rg pattern"))
        self.assertIsNotNone(result)

    def test_blocks_find(self):

        result = PreToolUseBashCommandRuleChecks.check_no_builtin_tool_bypass(self._build("find . -name '*.py'"))
        self.assertIsNotNone(result)

    def test_blocks_fd(self):

        result = PreToolUseBashCommandRuleChecks.check_no_builtin_tool_bypass(self._build("fd '*.py'"))
        self.assertIsNotNone(result)

    def test_blocks_ls(self):

        result = PreToolUseBashCommandRuleChecks.check_no_builtin_tool_bypass(self._build("ls"))
        self.assertIsNotNone(result)

    def test_blocks_ls_with_args(self):

        result = PreToolUseBashCommandRuleChecks.check_no_builtin_tool_bypass(self._build("ls -la"))
        self.assertIsNotNone(result)

    def test_blocks_tree(self):

        result = PreToolUseBashCommandRuleChecks.check_no_builtin_tool_bypass(self._build("tree ."))
        self.assertIsNotNone(result)

    def test_passes_echo(self):

        result = PreToolUseBashCommandRuleChecks.check_no_builtin_tool_bypass(self._build("echo hello"))
        self.assertIsNone(result)

    def test_passes_git(self):

        result = PreToolUseBashCommandRuleChecks.check_no_builtin_tool_bypass(self._build("git diff"))
        self.assertIsNone(result)

    def test_blocks_grep_after_pipe(self):

        result = PreToolUseBashCommandRuleChecks.check_no_builtin_tool_bypass(self._build("echo hello | grep hello"))
        self.assertIsNotNone(result)
